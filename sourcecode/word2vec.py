...
if __name__ == '__main__':
    ...
    root_dit = f'./dataset_func/'
    model_dir = './model/newdataset'

# w2v:
    # train_x = read_morecontract(root_dit)
    ...
    # with open('./dataset/temp_train_data.txt', 'w', encoding='utf-8') as f: 
    #     for line in train_x: 
    #         f.writelines(line)
    #         f.write('\n')
    # 训练FastText模型 
    
    # file_path = './dataset/temp_train_data.txt'
